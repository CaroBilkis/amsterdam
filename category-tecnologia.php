...
<div class="container">
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm12">
      <h2 class="titulo2-left">Tecnología</h2>
    ...
    <div class="col-lg-12 col-md-12 col-sm12">
      <div class="containerc">
        ...
        <div class="tag virtualidad" id="tab-virtualidad">
          <button  type="button" class="btn btn-secondary t5-tag" name="category" value="Virtualidad" onclick="tag('Virtualidad');hide('tab-virtualidad');show('virtualidad');hideFilter('tipo');">
            Virtualidad <span class="badge badge-light"><i class="fas fa-times"></i></span>
          </button>
        </div>
        ...
        <div class="tag audiovisuales" id="tab-audiovisuales">
          <button  type="button" class="btn btn-secondary t5-tag" name="category" value="Audiovisuales" onclick="tag('Audiovisuales');hide('tab-audiovisuales');show('audiovisuales');hideFilter('tipo');">
    ...
    <div class="col-lg-2 col-md-2 col-sm2">
        ...
        <div class="ct t5" id ="tipo">
          <h4 class="t4">Tipo</h4>
          <label class="btn" id='virtualidad' >
            <input  class="btn-check"type="checkbox"  onclick="filterSelection();show('tab-virtualidad');hide('virtualidad');hideFilterTecnologia('tipo');" name="category" value="Virtualidad"> Virtualidad
          </label>
          <br>

          <label class="btn" id='debates' >
            <input  class="btn-check"type="checkbox"  onclick="filterSelection();show('tab-debates');hide('debates');hideFilterTecnologia('tipo');" name="category" value="Debates"> Debates
          </label>
          <br>

            <label class="btn" id='audiovisuales' >
              <input  class="btn-check"type="checkbox" onclick="filterSelection();show('tab-audiovisuales');hide('audiovisuales');hideFilterTecnologia('tipo');" name="category" value="Audiovisuales"> Audiovisuales
            </label>
            <br>

            <label class="btn" id='varios' >
              <input  class="btn-check"type="checkbox"  onclick="filterSelection();show('tab-varios');hide('varios');hideFilterTecnologia('tipo');" name="category" value="Varios"> Varios
            </label>
            <br>
